...
public class DemoTableController extends BaseController
{
    ...
    @ResponseBody
    public com.community.common.core.domain.AjaxResult exportSelected(UserTableModel userModel, String userIds)
    {
        List<UserTableModel> userList = new ArrayList<UserTableModel>(Arrays.asList(new UserTableModel[users.size()]));
        Collections.copy(userList, users);

        // 条件过滤
        if (com.community.common.utils.StringUtils.isNotEmpty(userIds))
        {
            userList.clear();
        ...
        com.community.common.utils.poi.ExcelUtil<UserTableModel> util = new ExcelUtil<UserTableModel>(UserTableModel.class);
    ...
    @ResponseBody
    public com.community.common.core.domain.AjaxResult ajaxColumns(UserTableColumn userColumn)
    {
    ...
    @PostMapping("/list")
    @ResponseBody
    public com.community.common.core.page.TableDataInfo list(UserTableModel userModel)
    {
        com.community.common.core.page.TableDataInfo rspData = new com.community.common.core.page.TableDataInfo();
        List<UserTableModel> userList = new ArrayList<UserTableModel>(Arrays.asList(new UserTableModel[users.size()]));
        Collections.copy(userList, users);
        // 查询条件过滤
        if (com.community.common.utils.StringUtils.isNotEmpty(userModel.getUserName()))
        {
            userList.clear();
            for (UserTableModel user : users)
            {
        ...
        com.community.common.core.page.PageDomain pageDomain = com.community.common.core.page.TableSupport.buildPageRequest();
    ...
    @ResponseBody
    public com.community.common.core.page.TableDataInfo treeList(AreaModel areaModel)
    {
        com.community.common.core.page.TableDataInfo rspData = new TableDataInfo();
        List<AreaModel> areaList = new ArrayList<AreaModel>(Arrays.asList(new AreaModel[areas.size()]));
        // 默认查询条件 parentId 0
        Collections.copy(areaList, areas);
        areaList.clear();
        if (com.community.common.utils.StringUtils.isNotEmpty(areaModel.getAreaName()))
        {
...
class UserTableModel
{
    ...
    /** 用户编号 */
    @com.community.common.annotation.Excel(name = "用户编号", cellType = com.community.common.annotation.Excel.ColumnType.NUMERIC)
    private String userCode;

    /** 用户姓名 */
    @com.community.common.annotation.Excel(name = "用户姓名")
    ...
    /** 用户手机 */
    @com.community.common.annotation.Excel(name = "用户手机")
    private String userPhone;

    /** 用户邮箱 */
    @com.community.common.annotation.Excel(name = "用户邮箱")
    private String userEmail;

    /** 用户余额 */
    @com.community.common.annotation.Excel(name = "用户余额", cellType = com.community.common.annotation.Excel.ColumnType.NUMERIC)
