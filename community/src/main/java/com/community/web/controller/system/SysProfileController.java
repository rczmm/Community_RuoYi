...
import com.community.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    {
        com.community.common.core.domain.entity.SysUser user = getSysUser();
        mmap.put("user", user);
    ...
    @ResponseBody
    public com.community.common.core.domain.AjaxResult resetPwd(String oldPassword, String newPassword)
    {
        com.community.common.core.domain.entity.SysUser user = getSysUser();
     ...
     * 修改用户
     */
    @com.community.common.annotation.Log(title = "个人信息", businessType = com.community.common.enums.BusinessType.UPDATE)
    @PostMapping("/update")
    @ResponseBody
    public com.community.common.core.domain.AjaxResult update(com.community.common.core.domain.entity.SysUser user)
    {
        com.community.common.core.domain.entity.SysUser currentUser = getSysUser();
        currentUser.setUserName(user.getUserName());
        currentUser.setEmail(user.getEmail());
        currentUser.setPhonenumber(user.getPhonenumber());
        currentUser.setSex(user.getSex());
        if (com.community.common.utils.StringUtils.isNotEmpty(user.getPhonenumber()) && !userService.checkPhoneUnique(currentUser))
        {
