package com.community.web.controller.demo.controller;
...
public class DemoFormController
{
    ...
    {
        com.community.common.core.domain.CxSelect cxSelectTB = new com.community.common.core.domain.CxSelect();
        cxSelectTB.setN("淘宝");
        cxSelectTB.setV("taobao");
        com.community.common.core.domain.CxSelect cxSelectTm = new com.community.common.core.domain.CxSelect();
        cxSelectTm.setN("天猫");
        cxSelectTm.setV("tm");
        com.community.common.core.domain.CxSelect cxSelectJhs = new com.community.common.core.domain.CxSelect();
        cxSelectJhs.setN("聚划算");
        cxSelectJhs.setV("jhs");
        List<com.community.common.core.domain.CxSelect> tmList = new ArrayList<com.community.common.core.domain.CxSelect>();
        tmList.add(cxSelectTm);
        tmList.add(cxSelectJhs);
        cxSelectTB.setS(tmList);

        com.community.common.core.domain.CxSelect cxSelectJD = new com.community.common.core.domain.CxSelect();
        cxSelectJD.setN("京东");
        cxSelectJD.setV("jd");
        com.community.common.core.domain.CxSelect cxSelectCs = new com.community.common.core.domain.CxSelect();
        cxSelectCs.setN("京东超市");
        cxSelectCs.setV("jdcs");
        com.community.common.core.domain.CxSelect cxSelectSx = new com.community.common.core.domain.CxSelect();
        cxSelectSx.setN("京东生鲜");
        cxSelectSx.setV("jdsx");
        List<com.community.common.core.domain.CxSelect> jdList = new ArrayList<com.community.common.core.domain.CxSelect>();
        jdList.add(cxSelectCs);
        jdList.add(cxSelectSx);
        cxSelectJD.setS(jdList);

        List<com.community.common.core.domain.CxSelect> cxList = new ArrayList<CxSelect>();
    ...
    {
        com.community.common.json.JSONObject.JSONArray list = new com.community.common.json.JSONObject.JSONArray();
        com.community.common.json.JSONObject item = new com.community.common.json.JSONObject();
    ...
    public String localRefreshTask(String fragment, String taskName, ModelMap mmap)
    {
        ...
        list.add(item);
        item = new com.community.common.json.JSONObject();
    ...
    @ResponseBody
    public com.community.common.core.domain.AjaxResult userModel()
    {
        com.community.common.core.domain.AjaxResult ajax = new com.community.common.core.domain.AjaxResult();
    ...
    @ResponseBody
    public com.community.common.core.domain.AjaxResult collection()
    {
        String[] array = { "ruoyi 1", "ruoyi 2", "ruoyi 3", "ruoyi 4", "ruoyi 5" };
        com.community.common.core.domain.AjaxResult ajax = new AjaxResult();
