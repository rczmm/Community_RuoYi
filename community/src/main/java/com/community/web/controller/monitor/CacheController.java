...
import com.community.framework.web.service.CacheService;
...
public class CacheController extends BaseController
{
    ...
    @ResponseBody
    public com.community.common.core.domain.AjaxResult clearCacheName(String cacheName, ModelMap mmap)
    {
    ...
    @ResponseBody
    public com.community.common.core.domain.AjaxResult clearCacheKey(String cacheName, String cacheKey, ModelMap mmap)
    {
    ...
    @GetMapping("/clearAll")
    @ResponseBody
    public com.community.common.core.domain.AjaxResult clearAll(ModelMap mmap)
    {
