package com.community.framework.shiro.web.filter.kickout;
...
public class KickoutSessionFilter extends AccessControlFilter
{
    ...
    private boolean isAjaxResponse(ServletRequest request, ServletResponse response) throws IOException
    {
        ...
        if (com.community.common.utils.ServletUtils.isAjaxRequest(req))
        {
            com.community.common.core.domain.AjaxResult ajaxResult = AjaxResult.error("您已在别处登录，请您修改密码或重新登录");
